...
function Row({title, fetchUrl}){
    ...
    return(
        <div className={styles.row}>
            ...
            <div className={styles.row_Conteneurs}>
                {movies.map(movies => (
                    // eslint-disable-next-line react/jsx-key
                    <div className={styles.row_divimage}>
                        <img key={movies.id} /*onClick={() => handleClick(movies)}*/ className={styles.row_images} src={`${base_url}${movies.backdrop_path}`} alt={movies.name} />
